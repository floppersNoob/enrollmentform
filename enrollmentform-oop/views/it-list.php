...
$bsitStudents = $student->displaySpecificStudent('BSIT');
?>
...
<h1>List of Enrollees in <strong> Information Technology </strong></h1>

<?php if (!empty($bsitStudents)) : ?>
...
<table>
    ...
    <?php foreach ($bsitStudents as $student) : ?>
        <tr>
