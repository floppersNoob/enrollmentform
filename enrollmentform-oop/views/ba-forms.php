...
<h2>BACHELOR OF SCIENCE IN <strong>BUSINESS ADMINISTRATION</strong> - Year Levels</h2>
<hr>
<p>Click your respected year level to proceed enrollment.</p>

<!-- Buttons -->
<div class="button-container">
<button id="btn01">BSBA 1</button>
<button id="btn02">BSBA 2</button>
<button id="btn03">BSBA 3</button>
<button id="btn04">BSBA 4</button>
</div>
...
<form class="modal-content animate" action="../actions/form-actions.php" method="post">
  <div class="modal-content">
    ...
    <h3>BACHELOR OF SCIENCE IN<strong> BUSINESS ADMINISTRATION</strong> - 1st Year</h3>
<hr>
    ...
    <div class="container">
      ...
      <input type="hidden" name="course" value="BSBA">
...
<form class="modal-content animate" action="../actions/form-actions.php" method="post">
  <div class="modal-content">
    ...
    <h3>BACHELOR OF SCIENCE IN<strong> BUSINESS ADMINISTRATION</strong> - 2nd Year</h3>
<hr>
    <h4>Below is the list of subjects in this year level:</h4>
    <h5>&nbsp;  • NETWORKING 1 <br>
...
<form class="modal-content animate" action="../actions/form-actions.php" method="post">
  <div class="modal-content">
    ...
    <h3>BACHELOR OF SCIENCE IN<strong> BUSINESS ADMINISTRATION</strong> - 3rd Year</h3>
<hr>
    <h4>Below is the list of subjects in this year level:</h4>
...
<form class="modal-content animate" action="../actions/form-actions.php" method="post">
  <div class="modal-content">
    ...
    <h3>BACHELOR OF SCIENCE IN<strong> BUSINESS ADMINISTRATION</strong> - 4th Year</h3>
<hr>
<h4>Below is the list of subjects in this year level:</h4>
