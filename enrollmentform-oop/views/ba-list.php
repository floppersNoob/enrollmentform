...
$bsbaStudents = $student->displaySpecificStudent('BSBA');
?>
...
<h1>List of Enrollees in BSBA</h1>

<?php if (!empty($bsbaStudents)) : ?>
...
<table>
    ...
    <?php foreach ($bsbaStudents as $student) : ?>
        <tr>
