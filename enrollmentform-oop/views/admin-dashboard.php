...
<ul>
    <li class="navtitle">ADMIN DASHBOARD</li>
    <li><a href="../actions/logout.php">Logout</a></li> 

    <li class="dropdown">
        <a class="dropbtn" href="#">List of Enrollees</a>
        <div class="dropdown-content">
            <a href="../views/it-list.php">BSIT</a>
            <a href="educ-list.php">EDUCATION</a>
            <a href="ba-list.php">BSBA</a>
        </div>
    </li>
